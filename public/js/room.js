document.addEventListener("DOMContentLoaded", () => {
  ...
  socket.addEventListener("open", () => {
    socket.send(JSON.stringify({ type: "join", room: roomName, identityHTML: fullIdentityHTML }));
    // Only send entrance if coming via frontdoor
  ...
  function sendMessage() {
    ...
    if (!msg) return;
    const data = { type: "message", room: roomName, identityHTML: fullIdentityHTML, mood: moodDropdown.value, postTo: postToDropdown.value, message: msg };
